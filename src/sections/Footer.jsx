            ...
            <footer className="max-container">
                <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
                    <div className="flex flex-col items-start">
                        <a href="/">
                            <img src="src\assets\images\footer-logo.svg" alt="logo" width={150} height={46} className="m-0" />
                        </a>
                        ...
                        <div className="flex items-center gap-5 mt-8">
                            <div className="flex justify-center items-center w-12 h-12 bg-white rounded-full">
                                <img src="src\assets\icons\facebook.svg" alt="facebook logo" width={24} height={24} />
                            </div>
                            <div className="flex justify-center items-center w-12 h-12 bg-white rounded-full">
                                <img src="src\assets\icons\twitter.svg" alt="twitter logo" width={24} height={24} />
                            </div>
                            <div className="flex justify-center items-center w-12 h-12 bg-white rounded-full">
                                <img src="src\assets\icons\instagram.svg" alt="instagram logo" width={24} height={24} />
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
                    <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
                        <img src="src\assets\icons\copyright-sign.svg" alt="copyright sign" width={20} height={20} className="rounded-full m-0" />
