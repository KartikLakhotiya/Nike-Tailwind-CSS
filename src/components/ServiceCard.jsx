...
const ServiceCard = ({ imgURL, label, subtext }) => {
    return (
        <div className='flex-1 w-full flex-col sm:w-[350px] sm:min-w-[350px] rounded-[20px] shadow-3xl px-10 py-16'>
            <div className='w-11 h-11 justify-center items-center bg-coral-red rounded-full flex'>
                <img src={imgURL} alt={label} width={24} height={24} />
            </div>
            <h3 className='mt-5 font-inter text-3xl leading-normal font-bold'>{label}</h3>
